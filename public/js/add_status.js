...
// Creates a single row from an Object representing a single record from statuses
addRowToTable = (data) => {
    ...
    statusIdCell.innerText = newRow.status_id;
    ...
    row.setAttribute('data-value', newRow.status_id);
